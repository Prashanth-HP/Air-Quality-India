...
def city_and_gases():
    ...
    st.header("🧪 NH₃ (Ammonia)")
    st.markdown(
        """
        - **🔍 Source**: 🚜 Agriculture (fertilizers, livestock waste), 🏭 industrial processes.  
        - **⚠️ Effects**: Causes 😷 respiratory irritation and contributes to the formation of fine particulate matter (PM2.5).
        """
    )
    ...
    st.markdown(
        ...
        - **⚠️ Effects**: Reduces 🫁 oxygen delivery in the body, leading to 🤕 headaches, dizziness, or even 🏴 death at high concentrations.
        """
    )

    st.header("🌫️ PM2.5 (Fine Particulate Matter)")
    st.markdown(
        """
        - **🔍 Source**: 🚗 Vehicle emissions, 🏭 industrial activities, 🔥 burning of biomass and coal.  
        - **⚠️ Effects**: Can penetrate deep into the 🫁 lungs, causing 🤒 respiratory diseases, ❤️‍🩹 heart problems, and 🦠 cancer.
        """
    )

    st.header("🌪️ PM10 (Coarse Particulate Matter)")
    st.markdown(
        """
        - **🔍 Source**: 🚧 Construction dust, 🛣️ road dust, 🏭 industrial emissions.  
        - **⚠️ Effects**: Causes 😷 lung irritation, worsens 🤧 asthma, and affects ❤️ cardiovascular health.
        """
    )
    ...
    st.markdown(
        ...
        - **⚠️ Effects**: Contributes to 🌆 smog formation, reduces 🫁 lung function, and reacts with other pollutants to form NO₂.
        """
    )

    st.header("💨 NO₂ (Nitrogen Dioxide)")
    st.markdown(
        """
        - **🔍 Source**: 🔥 Fossil fuel combustion, 🚗 vehicle emissions, 🏭 industrial processes.  
        - **⚠️ Effects**: Causes 😵‍💫 lung inflammation, worsens 🤧 asthma, and contributes to 🌧️ acid rain formation.
        """
    )

    st.header("⚡ NOx (Nitrogen Oxides - NO + NO₂ mixture)")
    st.markdown(
        """
        - **🔍 Source**: 🔥 Combustion of fuel in 🚗 vehicles, ⚡ power plants, and 🏭 industrial facilities.  
        - **⚠️ Effects**: Major contributor to 🌆 smog, 🌧️ acid rain, and 🤒 respiratory illnesses.
        """
    )

    st.header("☁️ SO₂ (Sulfur Dioxide)")
    st.markdown(
        """
        - **🔍 Source**: 🏭 Coal and oil burning in power plants, industrial facilities.  
        - **⚠️ Effects**: Causes 😷 respiratory issues, contributes to 🌧️ acid rain, and can 🌾 damage crops.
        """
    )

    st.title("🏙️ Cities Covered in the Dataset")
    st.write(
    ...
    st.markdown(
        """
        - 🏙️ **Metro cities** (like Delhi and Mumbai) experience high **PM2.5** and **NO₂** levels due to 🚗 traffic and 🏭 industries.  
        - 🏭 **Industrial towns** (like Talcher and Brajrajnagar) may have high **SO₂** and **NOx** levels due to power plants and factories.  
    ...
    st.markdown(
        ...
        - **⚖️ Compare Pollution Levels** – Identify the most and least polluted cities for specific pollutants.  
